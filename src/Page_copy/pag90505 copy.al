...
//                 {
//                     ApplicationArea = Manufacturing;
//                     ToolTip = 'Specifies the name of the journal template that the journal is based on.';
//                     Editable = false;
//                 }
...
//                     begin
//                         CurrPage.SaveRecord();
//                         ItemJnlMgt.LookupName(Rec."Journal Batch Name", Rec);
//                         CurrPage.Update(false);
//                     end;

//                     trigger OnValidate()
//                     begin
//                         ItemJnlMgt.CheckName(Rec."Journal Batch Name", Rec);
//                     end;
//                 }
//                 field("Line No."; Rec."Line No.")
//                 {
//                     ApplicationArea = Manufacturing;
//                     ToolTip = 'Specifies the line number for this journal line.';
//                     Editable = false;
//                 }
...
//                         ProdOrderList: Page "Released Production Orders";
//                     begin
...
//                             Rec.Validate("Order No.", ProdOrder."No.");
//                             CurrPage.Update(false);
//                         end;
//                     end;
//                 }
...
//                     Editable = false;
//                     ToolTip = 'Shows the description of the production order.';
//                 }
...
//                     Editable = false;
//                     ToolTip = 'Shows the name of the operation.';
//                 }
//             }
...
//             group("Quantities and Costs")
//             {
//                 Caption = 'Quantities and Costs';
...
//             group("Location and Warehouse")
//             {
//                 Caption = 'Location and Warehouse';
...
//         area(factboxes)
//         {
//             part("Item Picture"; "Item Picture")
//             {
//                 ApplicationArea = Manufacturing;
//                 SubPageLink = "No." = field("Item No.");
//             }
//             // part("Item Statistics FactBox"; "Item Statistics FactBox")
//             // {
//             //     ApplicationArea = Manufacturing;
//             //     SubPageLink = "No." = field("Item No.");
//             // }
...
//                 }
//                 action("Calculate Standard Cost")
//                 {
//                     ApplicationArea = Manufacturing;
//                     Caption = 'Calculate Standard Cost';
//                     Image = CalculateInventory;
//                     ToolTip = 'Calculate the standard cost for the item on the journal line.';

//                     trigger OnAction()
//                     begin
//                         if Rec."Item No." <> '' then
//                             // Rec.CalculateStandardCost();
//                         CurrPage.Update();
//                     end;
//                 }
//             }
...
//                         CurrPage.Update(false);
//                         Message('Output has been posted successfully.');
//                     end;
//                 }
...
//                         CurrPage.Update(false);
//                         Message('Output has been posted and printed successfully.');
//                     end;
//                 }
//             }
//         }
...
//         // Initialize journal batch if not set
//         if Rec."Journal Template Name" = '' then begin
//             Rec."Journal Template Name" := 'OUTPUT';
